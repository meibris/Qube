...
export default async function MapInvestPage({ searchParams }: { searchParams: Promise<{ freeplay?: string }> }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black">
      <div className="relative w-full h-full">
        <GameMap variant="lessonInvest" initialCoins={initialCoins} playerColor={playerColor} freeplay={freeplay==="1"} />
        <Link
          href="/learn"
